  ...
  return (
    <Router>
      <ul className="breadcrumb">
        ...
        <li><Link to="/duckling"> Duckling </Link></li>
      </ul>
      <Routes>
        <Route path="/" element={<Home/>} />
        <Route path="kittens" element={<Animal name="kitten" img="imgs/kitten.jpg" />} />
        <Route path="puppies" element={<Animal name="puppies" img="imgs/puppy.jpg" />} />
        <Route path="duckling" element={<Animal name="duckling" imgs="imgs/duckling.jpg" />} />
      </Routes>
  </Router>
  );
}
